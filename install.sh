...
apt install git
git clone -b master https://github.com/alireza-2030/backhaul-manager.git 3xui-multi-protocol
...
git clone -b master https://github.com/alireza-2030/backhaul-manager.git 3xui-multi-protocol
  ...
  wget https://raw.githubusercontent.com/alireza-2030/backhaul-manager/master/3xui-multi-protocol.service
